...
public class LargerItemStackHandler extends ItemStackHandler {
    ...
    public LargerItemStackHandler(int size) {
        this(size, null);
    }

    public LargerItemStackHandler(int size, Runnable onContentsChanged) {
        super(size);
     ...
     */
    public LargerItemStackHandler copy() {
        var newInventory = new LargerItemStackHandler(this.getSlots(), this.onContentsChanged);
    ...
    public static LargerItemStackHandler create(int size) {
        return create(size, builder -> {});
    }

    public static LargerItemStackHandler create(int size, Consumer<LargerItemStackHandler> builder) {
        return create(size, null, builder);
    }

    public static LargerItemStackHandler create(int size, Runnable onContentsChanged, Consumer<LargerItemStackHandler> builder) {
        var handler = new LargerItemStackHandler(size, onContentsChanged);
