...
//	}
//
//	private BasicTableContainer(MenuType<?> type, int id, Inventory playerInventory, Function<Player, Boolean> isUsableByPlayer, LargerItemStackHandler inventory) {
//		super(type, id);
//		this.isUsableByPlayer = isUsableByPlayer;
//		this.world = playerInventory.player.level;
//		this.result = new ResultContainer();
//
//		var matrix = new LargerCraftingInventory(this, inventory, 3);
//
